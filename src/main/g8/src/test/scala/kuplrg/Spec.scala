...
class Spec extends SpecBase {
  ...
  // Tests for `pdafs2es`
  // ---------------------------------------------------------------------------
  check(mustEqualLang(pdafs2es(pda1).langByEmptyStacks, pda1.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda2).langByEmptyStacks, pda2.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda3).langByEmptyStacks, pda3.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda4).langByEmptyStacks, pda4.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda5).langByEmptyStacks, pda5.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda6).langByEmptyStacks, pda6.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda7).langByEmptyStacks, pda7.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda8).langByEmptyStacks, pda8.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda9).langByEmptyStacks, pda9.langByFinalStates))
  check(mustEqualLang(pdafs2es(pda10).langByEmptyStacks, pda10.langByFinalStates))

  // ---------------------------------------------------------------------------
  // Tests for `pdaes2fs`
  // ---------------------------------------------------------------------------
  check(mustEqualLang(pdaes2fs(pda11).langByFinalStates, pda11.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda12).langByFinalStates, pda12.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda13).langByFinalStates, pda13.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda14).langByFinalStates, pda14.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda15).langByFinalStates, pda15.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda16).langByFinalStates, pda16.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda17).langByFinalStates, pda17.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda18).langByFinalStates, pda18.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda19).langByFinalStates, pda19.langByEmptyStacks))
  check(mustEqualLang(pdaes2fs(pda20).langByFinalStates, pda20.langByEmptyStacks))

  // ---------------------------------------------------------------------------
  // Tests for `cfg2pdaes`
  // ---------------------------------------------------------------------------
  val cfg1 = CFG("'S -> a 'S | <e> ;;")
  check(mustEqualLang(cfg2pdaes(cfg1).langByEmptyStacks, lang_an))
  val cfg2 = CFG("'S -> a 'S b | <e> ;;")
  check(mustEqualLang(cfg2pdaes(cfg2).langByEmptyStacks, lang_an_bn))
  val cfg3 = CFG("'S -> a 'S b b | <e> ;;")
  check(mustEqualLang(cfg2pdaes(cfg3).langByEmptyStacks, lang_an_b2n))
  val cfg4 = CFG("'S -> a 'S a | b 'S b | <e> ;;")
  check(mustEqualLang(cfg2pdaes(cfg4).langByEmptyStacks, lang_w_wR))
  val cfg5 = CFG("'S -> a 'S b 'S | b 'S a 'S | <e> ;;")
  check(mustEqualLang(cfg2pdaes(cfg5).langByEmptyStacks, lang_na_eq_nb))
  val cfg6 = CFG("'S -> <e> | a 'S b 'S | c 'S b 'S | b 'S a 'S | b 'S c 'S ;;")
  check(mustEqualLang(cfg2pdaes(cfg6).langByEmptyStacks, lang_na_eq_nb_minus_nc))
  val cfg7 = CFG("'S -> aa 'S bb | ab ;;")
  check(mustEqualLang(cfg2pdaes(cfg7).langByEmptyStacks, lang_a2n1_b2n1))
  val cfg8 = CFG("'S -> aa 'S bb | <e> ;;")
  check(mustEqualLang(cfg2pdaes(cfg8).langByEmptyStacks, lang_a2n_b2n))
  val cfg9 = CFG("'S -> b 'S bb | 'A ;; 'A -> a 'A | <e> ;;")
  check(mustEqualLang(cfg2pdaes(cfg9).langByEmptyStacks, lang_bn_am_b2n))
  val cfg10 = CFG("'S -> 'A 'S | <e> ;; 'A -> ( 'S ) | { 'S } | <e> ;;")
  check(mustEqualLang(cfg2pdaes(cfg10).langByEmptyStacks, lang_balanced))
